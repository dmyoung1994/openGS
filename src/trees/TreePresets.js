...
export function createTreePreset(name = 'spreading-oak', seed = 1) {
  ...
  if (name === 'weeping-willow') { p.gScale = 14; p.levels = 4; d.plant.structure.droop = 1.1; p.leaves.shape = 'lanceolate'; p.leaves.scaleX = 0.22; p.leaves.count = 18000; }
  ...
  if (name === 'clipped-hedge') { p.shape = 'cylindrical'; d.plant.structure.crownX = 1; d.plant.life.deciduous = 0; d.plant.envelope = { shape: 'box', width: 3, depth: 1.6, height: 1.6, baseHeight: 0 }; }
