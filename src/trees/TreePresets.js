...
export function createTreePreset(name = 'spreading-oak', seed = 1) {
  ...
  Object.assign(d.plant.structure, {
    rootCount: 7, rootSpread: 2.3, rootDepth: 0.7, rootRise: 0.16, rootFlatten: 2.4,
  ...
  if (name === 'whorled-fir') {
    ...
    Object.assign(d.plant.structure, { rootCount: 5, rootSpread: 2.6, rootDepth: 0.8, rootRise: 0.14, rootFlatten: 1.9, buttress: 0.5, buttressCount: 5 });
  }
  if (name === 'tall-pine') {
    ...
    Object.assign(d.plant.structure, { rootCount: 6, rootSpread: 2.8, rootDepth: 0.85, rootRise: 0.15, rootFlatten: 2.0, buttress: 0.55, buttressCount: 6 });
  }
  if (name === 'palm') {
  ...
  if (name === 'weeping-willow') { p.gScale = 14; p.levels = 4; d.plant.structure.droop = 1.1;
    Object.assign(d.plant.structure, { rootCount: 8, rootSpread: 3.4, rootDepth: 0.4, rootRise: 0.13, rootFlatten: 2.5, buttress: 0.6, buttressCount: 8 }); p.leaves.shape = 'lanceolate'; p.leaves.scaleX = 0.22; p.leaves.count = 18000; }
  if (name.includes('shrub') || name === 'clipped-hedge') {
    ...
    Object.assign(d.plant.structure, { rootCount: 3, rootSpread: 1.6, rootDepth: 0.45, rootRise: 0.12, rootFlatten: 1.6, buttress: 0.15, buttressCount: 3 });
  }
