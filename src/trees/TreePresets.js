...
export function createTreePreset(name = 'spreading-oak', seed = 1) {
  ...
  Object.assign(d.plant.structure, {
    rootCount: 7, rootSpread: 3.6, rootDepth: 0.8, rootRise: 1.15, rootBlade: 1.5,
  ...
  if (name === 'whorled-fir') {
    ...
    Object.assign(d.plant.structure, { rootCount: 5, rootSpread: 4.0, rootDepth: 0.9, rootRise: 0.7, rootBlade: 1.75, buttress: 0.3, buttressCount: 5 });
  }
  if (name === 'tall-pine') {
    ...
    Object.assign(d.plant.structure, { rootCount: 6, rootSpread: 4.4, rootDepth: 1.0, rootRise: 0.75, rootBlade: 1.9, buttress: 0.35, buttressCount: 6 });
  }
  if (name === 'palm') {
  ...
  if (name === 'weeping-willow') { p.gScale = 14; p.levels = 4; d.plant.structure.droop = 1.1;
    Object.assign(d.plant.structure, { rootCount: 8, rootSpread: 5.5, rootDepth: 0.45, rootRise: 0.6, rootBlade: 1.35, buttress: 0.4, buttressCount: 8 }); p.leaves.shape = 'lanceolate'; p.leaves.scaleX = 0.22; p.leaves.count = 18000; }
  if (name.includes('shrub') || name === 'clipped-hedge') {
    ...
    Object.assign(d.plant.structure, { rootCount: 3, rootSpread: 2.2, rootDepth: 0.5, rootRise: 0.5, rootBlade: 1.3, buttress: 0.15, buttressCount: 3 });
  }
