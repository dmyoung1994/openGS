...
function finalLiveReviewPrompt(observation) {
  return `Perform the final adversarial visual review for the live course build. The browser has published a complete production-WebGPU tour at:
