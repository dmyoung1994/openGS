...
- Use densely evaluated shared spline outlines for complex green boundaries. Antialias green and collar cuts by their screen-space footprint; keep collision classification on the same authored SDF and do not conceal polygon facets with broad material blends.
